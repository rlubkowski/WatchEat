...
{
    public class WeightActivityPageViewModel : BaseViewModel
    {
        public WeightActivityPageViewModel(DateTime date)
        {
        ...
        public WeightActivityPageViewModel(WeightEntry water)
        {
